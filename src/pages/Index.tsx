...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Download Button */}
      <section className="container py-8 md:py-16 flex flex-col items-center gap-6 md:gap-8">
        <div className="w-full max-w-4xl">
          <img src={bannerMobile} alt="Baixe e cadastre-se para receber os benefícios" className="w-full rounded-xl block md:hidden" />
          <img src={banner} alt="Baixe e cadastre-se para receber os benefícios" className="w-full rounded-xl hidden md:block" />
        </div>
        <Button className="bg-primary text-primary-foreground hover:bg-primary/90 rounded-3xl px-12 py-8 text-2xl md:px-48 md:py-24 md:text-6xl font-bold shadow-2xl">
          Download
        </Button>
      </section>
